...
class Solution {
    private  static void f(int ind, int remain, int target, ArrayList<ArrayList<Integer>> list, ArrayList<Integer> ds){
        
        if(target==ds.size() && remain ==0){
